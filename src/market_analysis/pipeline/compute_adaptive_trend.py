...
def compute_adaptive_trend_for_symbol(
    symbol: str,
    *,
    lookback_bars: int,
    ...
    """Compute one read-only adaptive trend result for dashboard consumption."""
    params = dict(settings.indicators.get("adaptive_trend", {}))
    ...
    if summary is None:
        raise ValueError("Adaptive trend calculation returned no result.")
